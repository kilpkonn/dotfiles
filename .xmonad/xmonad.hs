...
myKeys conf@(XConfig {XMonad.modMask = modm}) =
  M.fromList $
    ...
    [ ((modm .|. shiftMask, xK_Return), spawn $ XMonad.terminal conf),
      -- launch dmenu
      ((modm, xK_p), spawn "~/script/launcher.sh || dmenu"),
      -- launch gmrun
...
myStartupHook = do
  ...
  spawnOnce "sleep 1; killall trayer; trayer --edge top --align right --widthtype request --padding 6 --SetDockType true --SetPartialStrut true --expand true --monitor 0 --transparent true --alpha 0 --tint 0x282c34  --height 26 --margin 6 --iconspacing 10 &"
